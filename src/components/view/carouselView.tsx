...
import { TravelCarousel, SlideData } from "@/components/ui/TravelCarousel";

const travelSlides: SlideData[] = [
  {
    title: "Discover BALI",
    button: "Explore Now",
...
export default function TravelPage() {
  return (
    <main className="min-h-screen flex items-center justify-center p-8 bg-white/30 backdrop-blur-md border border-white/20 rounded-lg">
    <TravelCarousel slides={travelSlides} />
  </main>  
  );
}
